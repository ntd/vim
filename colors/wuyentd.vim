...
let g:colors_name = "wuyentd"

""""""""\ Highlighting groups for various occasions \""""""""
hi SpecialKey gui=NONE guifg=#000000 guibg=#00008B cterm=NONE ctermfg=black ctermbg=darkblue
hi NonText gui=NONE guifg=yellow guibg=bg cterm=NONE ctermfg=yellow ctermbg=black
...
hi StatusLine gui=NONE guifg=#FFFFFF guibg=#203080 cterm=bold ctermfg=white ctermbg=darkblue
...
hi Folded gui=BOLD guifg=#008B00 guibg=bg cterm=BOLD ctermfg=green ctermbg=black
hi FoldColumn gui=NONE guifg=#008B00 guibg=bg cterm=NONE ctermfg=green ctermbg=black
...
hi Normal gui=NONE guifg=#E6E6FA guibg=black cterm=NONE ctermfg=gray ctermbg=black
...
hi Identifier gui=NONE guifg=#00BFFF guibg=bg cterm=NONE ctermfg=lightcyan ctermbg=black
 hi Function gui=BOLD guifg=#00BFFF guibg=bg cterm=NONE ctermfg=lightcyan ctermbg=black
